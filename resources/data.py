...
RAID = [
    ...
    "KING RANDI KA BACHA ISKI MA KI CHUT MARO OPP🤤🤤",
    "KING KI MAA RANDI KI CHODI KALI CHUT KI BACHI",
    "PHANTOM KI MUMMY KO CHODO VERY OPP🤤💖",
    " RADHEY APKI KAA KAHI ORR CHUDVA BE LOVADE",
    " ARCHU RANDI KO CHODO TAIL LAGA KE MACHINE KA",
]
