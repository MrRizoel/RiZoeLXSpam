...
@Riz.on(events.NewMessage(pattern=".inviteall"))
@Riz2.on(events.NewMessage(pattern=".inviteall"))
@Riz3.on(events.NewMessage(pattern=".inviteall"))
@Riz4.on(events.NewMessage(pattern=".inviteall"))
@Riz5.on(events.NewMessage(pattern=".inviteall"))
@Riz6.on(events.NewMessage(pattern=".inviteall"))
@Riz7.on(events.NewMessage(pattern=".inviteall"))
